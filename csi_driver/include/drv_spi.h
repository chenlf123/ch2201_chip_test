...
/**
  \brief         using dma send data to SPI transmitter,(received data is ignored).
               \ref spi_event_e is signaled when operation completes or error happens.
               \ref csi_spi_get_status can get operation status.
  \param[in]   handle spi handle to operate.
  \param[in]   data  Pointer to buffer with data to send to SPI transmitter. data_type is : uint8_t for 1..8 data bits, uint16_t for 9..16 data bits,uint32_t for 17..32 data bits,
  ...
  \return      error code
*/
int32_t csi_spi_send_dma(spi_handle_t handle, const void *data, uint32_t num);
...
/**
  \brief       using dma receive data from SPI receiver.
               \ref spi_event_e is signaled when operation completes or error happens.
               \ref csi_spi_get_status can get operation status.
  \param[in]   handle spi handle to operate.
  \param[out]  data  Pointer to buffer for data to receive from SPI receiver
  ...
  \return      error code
*/
int32_t csi_spi_receive_dma(spi_handle_t handle, void *data, uint32_t num);
...
/**
  \brief       using dma send/receive data to/from SPI transmitter/receiver.
               \ref spi_event_e is signaled when operation completes or error happens.
               \ref csi_spi_get_status can get operation status.
  \param[in]   handle spi handle to operate.
  \param[in]   data_out  Pointer to buffer with data to send to SPI transmitter
  ...
  \return      error code
*/
int32_t csi_spi_transfer_dma(spi_handle_t handle, const void *data_out, void *data_in, uint32_t num_out, uint32_t num_in);
